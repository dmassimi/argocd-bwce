...
# ArgoCD BWCE GitOps Setup Guide

This document provides a complete walkthrough for cleaning a local Kubernetes environment and setting up a fresh ArgoCD pipeline for a private BWCE (BusinessWorks Container Edition) repository.
...
cd C:\Users\dmassimi\containers\argocd-bwce\bwce-manifests
kubectl.exe apply -f .\my-license-secret.yaml -n bwce-test
cd C:\Users\dmassimi\containers\argocd-bwce\argocd-apps
